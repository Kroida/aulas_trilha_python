...
# Dicionário representando o baralho, com cartas e suas descrições.
baralho = {
...
# Dicionário que armazena as cartas já sorteadas.
caixa_de_sequencias = {}

# Lista para armazenar as sequências criadas.
...
def tirar_sequencias():
  """
  Retira uma sequência de cartas do baralho e as adiciona
  à caixa de sequências e à lista de sequências para mostrar.
  """
  if not baralho:
...
def mostrar_sequencias():
  """Exibe as sequências criadas pelo usuário."""
  if not caixa_de_sequencias:
      print('\nVocê ainda não tirou nenhuma sequência de cartas. Suas sequências aparecerão aqui.\n')
...
def exibir_info():
  """Exibe a descrição de uma carta específica."""
  if not caixa_de_sequencias:
...
def embaralhar():
  """
  Embaralha o baralho, retornando as cartas já sorteadas para a pilha principal.
  """
  if not caixa_de_sequencias:
